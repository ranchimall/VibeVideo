...
def animate_zoom(strip, source_width, source_height, contain_scale, cover_scale,
    ...
    (focus_x, focus_y), hold, then return to normal. Eased Bezier
    keyframes for a smooth "punch in". Pan is clamped so the video's
    real edge is never exposed.
    """
...
def main():
    ...
    for entry in ZOOM_RANGES:
        ...
        animate_zoom(
            ...
            zoom_fade_frames, focus_x, focus_y, zoom_factor,
        )
